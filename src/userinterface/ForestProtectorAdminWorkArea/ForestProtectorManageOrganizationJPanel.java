 ...
 */
public class ForestProtectorManageOrganizationJPanel extends javax.swing.JPanel {
   ...
   public  ForestProtectorManageOrganizationJPanel(JPanel container, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business) {
        initComponents();
     ...
     private void populateCombo(){
        ...
        for (Organization.Type type : Organization.Type.values()){
            if((String.valueOf(type).equals("PayRollAdmin" )) || (String.valueOf(type).equals("ForestProtectorRequestData")) ){
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 130, 510, 140));
        ...
        add(comboType, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 300, 180, -1));
        ...
        add(btnAddOrganization, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 360, -1, -1));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 610, -1, -1));

 ...
 */
public class RenderRequestSupplierInventoryJPanel extends javax.swing.JPanel {
    ...
    public RenderRequestSupplierInventoryJPanel(JPanel container, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business) {
        initComponents();
    ...
    public void populateTable(){
        ...
        for(WorkRequest request: organization.getWorkQueue().getWorkRequestList()){
            System.out.println("RENDERORRENTAL"+request.getRentalorrender());
    ...
    */
    ...
    private void initComponents() {
        ...
        tblInventory.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sender", "Receiver", "Supplier", "Product", "Status", "Quantity"
            }
        ) {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 50, 960, 470));
        ...
        add(btnAssign, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 540, -1, -1));
        ...
        add(btnProcess, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 540, -1, -1));
    ...
    private void btnProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessActionPerformed
        ...
        RenderWorkRequest request = (RenderWorkRequest)tblInventory.getValueAt(selectedRow, 4);
     
        request.setStatus("Processing");
       RequestReceivedProcessInventoryJPanel1 renderprocesssupplierinventory = new RequestReceivedProcessInventoryJPanel1(container,account,organization,enterprise,business,request);
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignActionPerformed
        ...
        WorkRequest request = (WorkRequest)tblInventory.getValueAt(selectedRow,4 );
